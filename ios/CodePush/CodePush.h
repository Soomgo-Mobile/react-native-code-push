...
/*
 * doneCallback is given what the attempts at installing the update from its update
 * archives ended in, or nil when the update had no archive to attempt. The result
